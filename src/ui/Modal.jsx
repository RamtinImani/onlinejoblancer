  ...
  return (
    open && (
      <div className="backdrop-blur-sm fixed top-0 left-0 w-full h-full flex items-center justify-center bg-secondary-500/30 z-50">
        <div className="w-[calc(100vw-2rem)] md:max-w-lg max-h-[calc(100vh-2rem)] overflow-y-auto bg-secondary-0 p-8 rounded-2xl shadow-md shadow-primary-300 transition-all duration-300">
